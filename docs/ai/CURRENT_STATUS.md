...
## 当前开发阶段
已发布 v2.0.1（公开 GitHub 仓库 + EXE/ZIP 两个 Release 资产）；v2.1.0 增量升级开发中。
...
## 当前正在处理
AI 模型中心核心、参考文献核心、官方集成层和首版 UI 已完成首轮测试；仍需完成工作流验收与发布门。

## 下一步
下一步：全自动/高级流程实际模型选择验证、引用导出验证、真实 Windows QA，然后准备 v2.1.0。
