...
def main():
    from scripts.release import (ReleaseError, bump_version, current_version,
                                 release_title, scan_secrets)

    assert bump_version("2.0.1", "patch") == "2.0.2"
    assert bump_version("2.0.1", "minor") == "2.1.0"
    assert bump_version("2.0.1", "major") == "3.0.0"
    assert release_title("2.1.2") == "论文助手 v2.1.2"
...
# 版本: v2.1.2 (2026-08-18) 更新: Release 标题规范测试
